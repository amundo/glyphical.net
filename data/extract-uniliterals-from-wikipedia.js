...
let headers = ['hieroglyph', 'color', 'depiction', 'uniliteral',
              'say', 'note', 'oldEgyptian', 'middleEgyptian']
...
Deno.writeTextFile('uniliterals.json', JSON.stringify({metadata, hieroglyphs}, null, 2))
