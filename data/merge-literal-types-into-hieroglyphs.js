...
hieroglyphs.hieroglyphs.forEach(hieroglyph => {
  ...
  if(uniliterals.hieroglyphs.find(uniliteral => uniliteral.hieroglyph == hieroglyph.hieroglyph)){
    let matched = uniliterals.hieroglyphs.find(uniliteral => uniliteral.hieroglyph == hieroglyph.hieroglyph)
    
    hieroglyph.metadata.type = 'uniliteral'
    hieroglyph.phonetic = matched.uniliteral
  }

  if(biliterals.hieroglyphs.find(biliteral => biliteral.hieroglyph == hieroglyph.hieroglyph)){
    let matched = biliterals.hieroglyphs.find(biliteral => biliteral.hieroglyph == hieroglyph.hieroglyph)

    hieroglyph.metadata.type = 'biliteral'
    hieroglyph.phonetic = matched.biliteral
  }
  
  if(triliterals.hieroglyphs.find(triliteral => triliteral.hieroglyph == hieroglyph.hieroglyph)){
    let matched = triliterals.hieroglyphs.find(triliteral => triliteral.hieroglyph == hieroglyph.hieroglyph)
