...
let cleanUpTable = table => {
  ...
  table.querySelectorAll('a').forEach(a => { a.outerHTML = a.textContent })
}
...
document.querySelectorAll('.mw-parser-output h3 span.mw-headline, .mw-parser-output table.wikitable')
.forEach((el, i) => {
